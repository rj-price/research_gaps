def get_summary_prompt(filename: str) -> str:
    ...
    2. **Methodology**: Summarise the experimental design or theoretical framework briefly. Avoid listing minute technical details unless they are the novel contribution of the paper.
...
def get_gaps_prompt(subject: str, combined_summaries: str) -> str:
    ...
    Read the summaries carefully. Your objective is to conduct a meta-analysis to synthesise the current state of the art and, critically, to uncover systemic **Research Gaps** that warrant new investigation. 
    ...
    - Identify the dominant methodologies and common themes. Do not just list the papers sequentially; synthesise their contributions.
